...
private:
  ...
  OMP_FORCE_INLINE void
  randomizeBoard(Hand &board, unsigned remainingCards, uint64_t usedCardsMask,
  ...
  static std::vector<std::vector<std::array<uint8_t, 2>>>
  removeInvalidCombos(const std::vector<CardRange> &handRanges,
